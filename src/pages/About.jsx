  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 font-sans text-gray-900 dark:text-white">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
        <span className="inline-block px-4 py-1.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 text-sm font-bold rounded-full mb-6">Our Story</span>
        <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">Art Deserves a Better Home.</h1>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Why ArtPool?</h2>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm space-y-6">
              <div>
                ...
                <div className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Active Users</div>
              </div>
              <div>
                <div className="text-3xl font-extrabold text-blue-600 mb-1">300+</div>
                <div className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Artists</div>
              </div>
              <div>
                <div className="text-3xl font-extrabold text-blue-600 mb-1">5,000+</div>
                <div className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Artworks Sold</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-16">Who is ArtPool for?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
              ArtPool gives you a professional portfolio, a direct sales channel, and a commission system — without taking a cut until you sell.
            </p>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">For Customers</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
              Discover original art from real artists. Buy physical pieces shipped directly to you, or commission something made exactly to your taste.
            </p>
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400 font-medium">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Built by</h2>
          <p className="text-gray-500 dark:text-gray-400 mb-16">A solo developer with a love for art and clean code.</p>
          <div className="flex justify-center">
            {team.map((member, i) => (
              <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm max-w-sm w-full">
      ...
      <section className="py-20 text-center px-4">
        <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-4">Join the community.</h2>
        <p className="text-gray-500 dark:text-gray-400 mb-8 text-lg">Whether you create or collect — ArtPool is your place.</p>
        <div className="flex justify-center gap-4">
          <button onClick={() => navigate('/signup')} className="inline-flex items-center gap-2 px-8 py-4 bg-black dark:bg-white dark:text-black text-white font-bold rounded-full hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors text-lg">
            Get Started <ArrowRight size={20} />
          </button>
          <button onClick={() => navigate('/gallery')} className="inline-flex items-center gap-2 px-8 py-4 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-bold rounded-full hover:border-gray-400 dark:hover:border-gray-500 transition-colors text-lg">
            Browse Gallery
          </button>
        </div>
      </section>
